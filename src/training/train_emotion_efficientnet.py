...
EPOCHS_PHASE1 = int(os.environ.get("TRAIN_WARMUP_EPOCHS", 5))   # head-only warmup
EPOCHS_PHASE2 = int(os.environ.get("TRAIN_EPOCHS", 30))
LR_PHASE1 = 1e-3
LR_PHASE2 = float(os.environ.get("TRAIN_LR", 3e-4))
FREEZE_RATIO = 0.50
VAL_SPLIT = 0.20
MODEL_DIR = os.path.join(PROJECT_ROOT, "models", "emotion_detection_2", "efficientnet")
