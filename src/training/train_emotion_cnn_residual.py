...
class Config:
    ...
    MODEL_SAVE_PATH = os.path.join(PROJECT_ROOT, "models", "emotion_cnn_residual.keras")
    H5_SAVE_PATH = os.path.join(PROJECT_ROOT, "models", "emotion_cnn_residual.h5")
    HISTORY_SAVE_PATH = os.path.join(PROJECT_ROOT, "models", "emotion_cnn_residual_history.json")
...
def resolve_class_folder_names(root_dir, classes):
    """Resolve class folders case-insensitively while preserving output order."""
